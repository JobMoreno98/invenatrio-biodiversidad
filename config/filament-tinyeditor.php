...
return [
    ...
    'profiles' => [
        ...
        'custom_biologo' => [
            ...
            'toolbar' => 'undo redo | blocks | bold italic | alignleft aligncenter alignright alignjustify | image media | code | removeformat',
            'options' => [
                'image_advtab' => true,
                'image_dimensions' => true,
                'image_caption' => true,
                'extended_valid_elements' => 'img[class|src|border|alt|title|hspace|vspace|width|height|align|style]',
            ],
        ],
